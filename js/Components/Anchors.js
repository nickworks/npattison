...
class Anchors {
	...
	setMargins(... args){
		...
		this._pxAnchorMin = vec2(0);
		this._pxAnchorMax = vec2(0);
	...
	calcRectFromParent(parentRect){
		this._pxAnchorMin = parentRect.getPositionOfAnchor(this.anchorMin);
		this._pxAnchorMax = parentRect.getPositionOfAnchor(this.anchorMax);
		
		const xMin = this._pxAnchorMin.x + this.marginLeft;
		const yMin = this._pxAnchorMin.y + this.marginTop;
		const xMax = this._pxAnchorMax.x - this.marginRight;
		const yMax = this._pxAnchorMax.y - this.marginBottom;
	...
	draw(){
		...
		gfx.fillStyle="#F88";
		gfx.fillCircle(this._pxAnchorMin.x,this._pxAnchorMin.y,4);
		
		gfx.fillStyle="#88F";
		gfx.fillCircle(this._pxAnchorMax.x,this._pxAnchorMax.y,4);
		
		gfx.fillStyle="#8F8";
		gfx.fillCircle(this._pxAnchorMin.x,this._pxAnchorMax.y,4);
		
		gfx.fillStyle="#8F8";
		gfx.fillCircle(this._pxAnchorMax.x,this._pxAnchorMin.y,4);
    }
	/*
